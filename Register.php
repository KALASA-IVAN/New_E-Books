...
<div class="container">
    ...
    <?php 
			...
			<form action="<?php echo base_url()."index.php/user/RegisterUser"?>" method="post">
                ...
                <div class="form-group custom-bottom-margin">
					<label class="control-label col-sm-4 text-right" for="filename">Filename</label>
					<div class="col-sm-5">
					  <input type="file" name="filename" class="form-control" value="<?php echo set_value('filename');?>" placeholder="Enter filename" id="filename">
					</div>
				</div>
                <div class="form-group custom-bottom-margin">
